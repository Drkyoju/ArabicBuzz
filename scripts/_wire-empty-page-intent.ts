...
const REQUEST_AR = [
  ...
  '١) ابحث عن صفحة فاضية موجودة في الملف = بلا أي كتابة إطلاقاً (ليست «شبه فاضية»، ليست صفحة 2 فيها بسم الله الرحمن الرحيم، ليست ترويسة/عنوان).',
  '٢) إن وُجدت: انسخها وضع النسخة بعد الصفحة 45 ثم أرسل بـ sendDocument للمجموعة («عمل الجماعة» / «عمل الجمعية»).',
  '٣) إن لم توجد صفحة بلا كتابة: أبلغ المجموعة صادقاً — ممنوع اختراع صفحة بيضاء وممنوع نسخ صفحة فيها كتابة.',
