...
description: "تحويل PDF↔Word عربي بلا طلاسم: Gemini أولاً، تصعيد صادق، رفض بدل ملف فاسد"
scope: shared
...
2. إن فشل بوابة الجودة → **Gemini أقوى** (نفس المفتاح؛ نموذج أقوى).
...
| Gemini | OCR/vision أول المسار | مفتاح موجود عادة |
| PaddleOCR | احتياطي رخيص ذاتي | اختياري عبر URL/ENABLE |
| Mistral OCR | تصعيد مدفوع إن لزم | فقط مع `MISTRAL_API_KEY` |
