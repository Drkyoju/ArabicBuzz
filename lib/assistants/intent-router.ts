...
const HEURISTICS: Array<{ id: AssistantId; re: RegExp }> = [
  ...
  {
    id: 'file-search',
    re: /ابحث|بحث\s*(في)?\s*(ال)?ملفات|قاعدة\s*المعرفة|دور\s*في\s*الملفات|درايف|drive|عقل\s*الشركة/,
  },
  {
    id: 'daily-brief',
    re: /ملخص\s*يوم|أجندة|مواعيد\s*(اليوم|الغد)|تقويم|calendar|موجز|أضف\s*موعد|سج[ّل]\s*موعد|احجز\s*(موعد|اجتماع)|اجتماع\s*(غد|اليوم|الساعة)/,
  },
  {
    id: 'day-captain',
