...
export async function getTelegramLinkStatus(
  ...
  if (!botConfigured) {
    ...
    hintAr =
      'لا محادثة مربوطة. خاص: افتح الرابط واضغط Start. مجموعة: أضف البوت ثم أرسل /link أو /start داخل المجموعة (لا نخترع معرّفات).'
  } else if (!hasScopeBinding) {
    hintAr =
      'التنبيهات جاهزة عبر محادثة المالك. لربط هذه المساحة أو مجموعة: أرسل /link في المحادثة أو افتح رابط Start أدناه.'
  }
