...
export const VOICE_MIC_HINT_AR =
  'قل طلبك («أبغا اللائحة…» أو «يا وكيل١ …») — بعد النسخ راجع ثم أرسل'

export const VOICE_HOW_TO_AR = `كيف يشتغل الصوت والوكلاء في غرفة الفريق:
• سجّل → راجع النص وعدّله → أرسل. لا حاجة لـ @.
• أمثلة: «أبغا اللائحة» · «أبغا الملف كذا» · «عدّل …» · «يا وكيل١ لخّص».
• «أبغا للجميع …» أو «للوكلاء: …» يشغّل الجاهزين معاً (بحد أقصى).
• كل رسالة في الغرفة المشتركة يطّلع عليها وكيل جاهز فوراً؛ الطلب يُنفَّذ، والدردشة برد قصير.
• اضغط مقعد الوكيل: شغال ↔ طافي. الطافي لا يرد. الافتراضي شغال على مدار الساعة.
حدود صادقة: جودة النسخ تعتمد على الميكروفون والشبكة ومفتاح Gemini/Whisper المجاني؛ راجع النص قبل الإرسال لتفادي الطلاسم.`
