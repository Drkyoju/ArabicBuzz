...
export const MCP_CATALOG: McpCatalogItem[] = [
  ...
  },
  {
    ...
    descriptionAr:
      'حزمة MCP بلا مفتاح: طقس/جغرافيا/صرف/قاموس/كتب/… — لهيرميس وCursor. المنتج على CranL له أدوات أصلية منفصلة (fx_rate/geocode/saudi_datetime/wayback_lookup/…).',
  ...
  {
    id: 'wayback-builtin',
    nameAr: 'أرشيف الويب (مدمج)',
    nameEn: 'Wayback (product builtin)',
    descriptionAr:
      'لقطات Internet Archive عبر wayback_lookup المدمج في المنتج — بلا MCP بعيد.',
    benefitsAr: 'استرجاع صفحات gov.sa/لوائح تغيّرت دون مفتاح.',
    categoryAr: 'ويب وبحث',
    runtime: 'remote',
    transport: 'sse',
    setupHintAr: 'لا إعداد — استخدم wayback_lookup من تيليجرام/الغرفة.',
    docsUrl: 'https://archive.org/help/wayback_api.php',
    recommended: true,
  },
  {
    id: 'saudi-datetime-builtin',
    nameAr: 'تاريخ السعودية + هجري (مدمج)',
    nameEn: 'Saudi datetime + Hijri (builtin)',
    descriptionAr:
      'توقيت Asia/Riyadh ميلادي+هجري عبر saudi_datetime (Intl محلي) — مكمّل لـ MCP time في Cursor.',
    benefitsAr: 'رد فوري للجمعية بدون مفتاح أو شبكة.',
    categoryAr: 'أدوات',
    runtime: 'remote',
    transport: 'sse',
    setupHintAr: 'لا إعداد — saudi_datetime على CranL؛ Cursor يبقى بـ MCP time.',
    recommended: true,
  },
  {
    id: 'brave-search',
