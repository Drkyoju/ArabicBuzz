...
export const DEMO_SCOPES: Scope[] = [
  {
    ...
    descriptionAr:
      'مكتبك اليومي — مهام سريعة وملفات وذاكرة خاصة بك فقط، بدون زملاء.',
    userId: 'user-1',
    keychain: {},
    privateMemory: [
      'هذه المساحة شخصية بالكامل: لا دعوات ولا حضور فريق.',
  ...
  },
  {
    ...
    nameAr: 'مكتب البحث',
    descriptionAr:
      'مسودات وتحليلات تجريبية — ابحث وجرّب هنا قبل ما تنقل النتيجة لغرفة الفريق.',
    userId: 'user-1',
    keychain: {},
    privateMemory: [
      'هذه مساحة مسودات: المخرجات هنا غير نهائية حتى تُنقل يدوياً لغرفة مشتركة.',
      'مشاريع قيد البحث: سياسات الموافقات، تدقيق SDAIA، مقارنة نماذج.',
      'عند الانتهاء من مسودة جيدة، اقترح نقل الخلاصة إلى «غرفة الفريق».',
    ],
  },
  {
    id: 'shared-demo',
    nameAr: 'غرفة الفريق',
    descriptionAr: 'بشر ووكلاء يعملون على نفس السياق — دعوات وحضور جماعي.',
  ...
  },
  {
    ...
    descriptionAr:
      'غرفة التشغيل اليومية: جداول Cron، تنبيهات تيليجرام، ومتابعة المهام الخلفية — مو للاجتماعات ولا لمسودات التقارير.',
    members: ['user-1', 'user-2'],
    memberLabelsAr: ['هوى', 'سارة'],
    agentLabelsAr: ['وكيل الجدولة', 'وكيل القنوات'],
    sharedMemory: [
      'هذه غرفة عمليات: راقب التشغيل والتنبيهات هنا، واكتب القرارات في «غرفة الفريق».',
      'قناة التنبيه: تيليجرام مربوطة بهذه المساحة.',
