...
export async function buildTelegramChatMemoryAr(opts: {
  ...
  lines.push(
    ...
    '',
    'قواعد ذاكرة:',
    '• قاعدة ذهبية: مرفق جديد في الرسالة = نسخة العمل فوراً — حتى لو أول مرة ولم يُرَ في Drive ولا الغرفة. نفّذ وأرجع بـ return_file.',
    '• ممنوع «مو بالدرايف» / «ما أعرف وين» / «أعد الإرسال» / الصمت إن وُجد مرفق أو fileId/بايتات/مهمة معلّقة.',
