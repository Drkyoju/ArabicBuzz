...
export function buildTelegramHelpAr(opts?: {
  ...
  return [
    ...
    '• بحث موحّد / ويب مجاني (DDG) / ويكيبيديا / يوتيوب / حساب / نطاق / arXiv / إحاطة الصباح',
    '• Drive + خزنة الغرفة + شبكة التخزين (Drive→تيليجرام→غرفة→ماك)',
    '• أرشفة المجموعة → Drive · تقويم الغرفة + مهام',
    '• بريد الجمعية + Gmail الشخصي (بعد الربط/الربط الشخصي)',
    '• خطابات رسمية · محضر من نقاش الغرفة',
    '• تحويل PDF/Word/Excel/PPTX · نسخ صفحة فاضية · تعليق PDF · OCR عربي',
    '• تبليغ عضو / المجموعة · /status حالة فقط للقراءة',
    '',
    'أمثلة:',
    '• إحاطة الصباح · ابحث في الغرفة عن … · ابحث في جوجل عن …',
    '• ويكيبيديا … · لخّص يوتيوب … · احسب … · استعلم النطاق … · ابحث في arXiv عن …',
    '• حوّل دولار لريال · أين تقع … · عرّف (إنجليزي) … · ابحث في HN عن …',
    '• قائمة ملفات الدرايف · جيب اللائحة · دور في الشبكة عن الملف',
    '• أرشف المجموعة إلى Drive · ارفع الملف إلى Drive',
    '• احجز موعد غداً ١٠ص · أضف مهمة …',
    '• خطاب شكر لـ … · محضر من الغرفة',
    '• حوّل إلى Word · انسخ صفحة فاضية · علّق على PDF · OCR',
