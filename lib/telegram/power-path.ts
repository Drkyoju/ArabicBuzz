  ...
  switch (kind) {
    case 'appointment':
      return [
        ...
        'استخرج العنوان والتاريخ/الوقت (توقيت السعودية Asia/Riyadh) وأي بريد للمدعوين.',
        'أنشئ فوراً عبر room_calendar_create (أو room_calendar_ingest إن وُجدت عدة تواريخ) مع attendees لأي بريد مذكور.',
        'لا تسأل «هل تود الإضافة؟» — نفّذ ثم أكّد بالعربية: العنوان · الوقت · المدعوين · أنّه مواعيد الجمعية/الفريق (تقويم الغرفة) — ليس تقويمك الشخصي على Google.',
...
- بحث جوجل/ويب: web_search (DDG مجاني). موقع/خريطة: geocode + روابط OSM/Google Maps من النتيجة. تاريخ هجري/رياض: saudi_datetime. أرشيف رابط: wayback_lookup.
- تشغيل تلقائي: ممنوع «هل تريد؟» للعمل الروتيني. إن نقص hop/LibreOffice/OCR: اذكر الخطوة التالية بالعربية (Drive · جسر الماك · ملف أصغر · انتظر) — بلا رفض غامض.
...
- التقويم الافتراضي: room_calendar_* = مواعيد الجمعية/الفريق المشتركة (Asia/Riyadh) — ليس تقويمك الشخصي على Google.
- البريد: mail_* (صندوق الجمعية) عند طلب صريح عن البريد/الوارد؛ gmail_* للشخصي بعد الربط — ممنوع مسح غير مطلوب أو دفع للمجموعة.
