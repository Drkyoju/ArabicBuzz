...
const HEAVY_WORK_RE =
  /(?:عدّل|عدل|عدلي|عدّلي|أنشئ|انشئ|اكتب|أكتب|حرّر|حرر|استبدل|احذف|امسح|ارفع|لخّص|لخص|حوّل|علّق|علق|تعليق|تمييز|pdf|docx|xlsx|word|excel|باور|ملف|مستند|قرار|محضر|drive|drive_sync|ocr|لائح|عقد|درايف|بريد|إيميل|ايميل|email|gmail)/iu
