-- Arabic Hybrid RAG: pgvector + Arabic FTS + HNSW
-- Apply with: psql "$DATABASE_URL" -f supabase/migrations/003_arabic_rag.sql
-- Or: npx prisma migrate deploy (mirrored under prisma/migrations)
