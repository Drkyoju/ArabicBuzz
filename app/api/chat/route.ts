...
- حلقة العمل الإلزامية للملفات:
  ...
  7) تحويل PDF↔Word/Office: convert_document فقط — قاعدة مطلقة بلا طلاسم. PDF→Word: Gemini Flash أولاً (يتصدر OCR Arena) → Gemini أقوى إن ضعف → PaddleOCR رخيص بعد فشل بوابة Gemini → Mistral إن وُجد المفتاح وما زال لازماً → محلي نظيف أو {ok:false, reason_ar} بلا مرفق. معطّل: Drive المعطوب، pdf-lib عربي، pdf2docx عربي. صدق > تسليم ملف فاسد. الناتج الناجح مرفق شات (معاينة+تنزيل).
