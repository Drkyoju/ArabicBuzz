...
const OWNER_START_STEPS: StartStep[] = [
  {
    titleAr: 'اجمع المستندات في مكان واحد',
    detailAr:
      'اربط Google وزامن مجلد الفريق — يقلّ فوضى واتساب/الملفات ويصير البحث ممكناً.',
    ctaAr: 'الإعدادات',
    target: 'settings',
  },
  {
    titleAr: 'ثبّت قناة الجوال',
    detailAr:
      'اربط تيليجرام لأرشفة الملفات والصوت تلقائياً — التنفيذ من الجوال بلا إعادة إرسال.',
    ctaAr: 'الربط',
    target: 'settings',
  },
  {
    titleAr: 'أول إحاطة أو موعد',
    detailAr:
      'من الغرفة: «إحاطة الصباح» أو أضف موعداً — وضوح يومي بدل الاعتماد على شخص واحد.',
    ctaAr: 'الغرفة',
    target: 'chats',
  },
]
...
const MEMBER_START_STEPS: StartStep[] = [
  {
    titleAr: 'غرفة الفريق',
    detailAr:
      'اكتب طلباً عربياً أو @الوكيل — أرشفة، بحث، تلخيص؛ الملفات لا تضيع في الدردشة.',
    ctaAr: 'افتح الغرفة',
    target: 'chats',
  },
  {
    titleAr: 'التقويم والمهام',
    detailAr: 'مواعيد ومهام مشتركة تظهر للجميع — لا إغلاق متأخر بلا أثر.',
    ctaAr: 'التقويم',
    target: 'calendar',
  },
  {
    titleAr: 'الملفات والمعرفة',
    detailAr: 'ارفع مستنداً أو اسأل عنه في الغرفة — المصدر من ملفاتكم لا من التخمين.',
    ctaAr: 'الملفات',
    target: 'files',
  },
]
        ...
        <div className="space-y-4 rounded-xl border border-ab-accent/25 bg-ab-accent/[0.05] p-4 sm:p-5">
          <div>
            ...
            <p className="mt-1 max-w-xl text-[12px] leading-relaxed text-ab-muted">
              {canAccessOpsUi
                ? 'اللوحة فارغة لأن الغرفة جديدة. ابدأ بأرشيف قابل للبحث + إحاطة يومية خفيفة — ثم تظهر المواعيد والمهام تلقائياً.'
                : 'افتح غرفة الفريق: ارفع ملفاً أو اطلب ملخصاً أو أضف موعداً. بلا إعدادات تقنية.'}
            </p>
          </div>
